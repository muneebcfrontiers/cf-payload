                ...
                {openIndex === i && children.length > 0 && (
                  <div
                    className={`
                        ...
                        ${i === menu.length - 1 ? "right-0" : "left-0"}
                    `}
...
//                                     <Link
//                                     href={sub.url ?? "#"}
//                                     className="block rounded-xl hover:bg-blue-50 p-4 transition"
//                                     >
//                                     <div className="flex gap-4 items-start">
//                                         {sub.image?.url && (
//                                         <div className="w-16 h-16 relative shrink-0">
...
//                         {/* RIGHT PANE: only if active submenu has children */}
//                         {children[activeSubIndex]?.children?.length ? (
//                         <div className="col-span-7">
//                             <div className="flex items-center justify-between mb-4">
//                             <Link
//                                 href={children[activeSubIndex].url ?? "#"}
